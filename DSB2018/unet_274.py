...
for n, id_ in tqdm(enumerate(train_ids), total=len(train_ids)):
    ...
    for i in range(5):
        cv2.imwrite("train_image_aug/train" + str(n)+"_"+str(i) + "_x_aug.bmp", (X_train[n+len(train_ids)*i]+1)*127.5)
        cv2.imwrite("train_image_aug/train" + str(n)+"_"+str(i) + "_y_aug.bmp", Y_train[n+len(train_ids)*i]*255)
...
for i in range(len(preds_test)):
    ...
    cv2.imwrite("test_image/test" + str(i) + "_y_notnorm.bmp", tmp)
    print("saving...")
