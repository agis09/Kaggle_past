...
x = df.loc[25001:35000, "comment_text"]
...
y = df.loc[25001:35000, "toxic":"identity_hate"]
y = y.as_matrix().astype('float16')

np.save('data25000~', data)
np.save('y25000~', y)
"""
    ...
    def data_generator():
        ...
        while True:
            ...
            for batch_num in range(num_batches_per_epoch):
                ...
                p = shuffled_data[start_index: end_index]
                q = shuffled_labels[start_index: end_index]
                yield p, q
