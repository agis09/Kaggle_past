...
checkpoint = ModelCheckpoint('./next_base.model', monitor='val_loss', verbose=1, save_best_only=True,
...
workers = 32 # DO NOT COMBINE MULTIPROCESSING WITH CACHE!
...
ax[0].legend()
ax[1].legend()
plt.savefig('next_base_model_Adam1e-3.png')
